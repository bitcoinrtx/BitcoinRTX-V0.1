...
"""Verify that starting bitcoinrtx with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinrtx with -h for help text")
        ...
        self.log.info("Start bitcoinrtx with -version for version information")
        ...
        self.log.info("Start bitcoinrtxd with -fakearg to make sure it does not start")
