...
class ToolWalletTest(BitcoinTestFramework):
    ...
    def bitcoin_wallet_process(self, *args):
        binary = self.config["environment"]["BUILDDIR"] + '/src/bitcoinrtx-wallet' + self.config["environment"]["EXEEXT"]
    ...
    def test_invalid_tool_commands_and_args(self):
        ...
        # `bitcoinrtx-wallet help` raises an error. Use `bitcoinrtx-wallet -help`.
