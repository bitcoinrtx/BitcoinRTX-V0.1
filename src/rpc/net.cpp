...
static UniValue getpeerinfo(const JSONRPCRequest& request)
{
            ...
            "    \"subver\": \"/BRTX:1.0.0/\",  (string) The string version\n"
...
static UniValue getaddednodeinfo(const JSONRPCRequest& request)
{
            ...
            "       {\n"
            "         \"address\" : \"192.168.0.201:7333\",  (string) The bitcoinrtx server IP and port we're connected to\n"
...
static UniValue getnetworkinfo(const JSONRPCRequest& request)
{
            ...
            "  \"subversion\": \"/BRTX:x.x.x/\",     (string) the server subversion string\n"
