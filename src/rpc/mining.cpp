...
static UniValue getnetworkhashps(const JSONRPCRequest& request)
{
            RPCHelpMan{"getnetworkhashps",
                ...
                {
                    {"nblocks", RPCArg::Type::NUM, /* default */ "5", "The number of blocks, or -1 for blocks since last difficulty change."},
    ...
    LOCK(cs_main);
    return GetNetworkHashPS(!request.params[0].isNull() ? request.params[0].get_int() : 5, !request.params[1].isNull() ? request.params[1].get_int() : -1);
}
...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated bitcoinrtx to."},
            ...
            + "If you are running the bitcoinrtx core wallet, you can get a new address to send the newly generated bitcoinrtx to with:\n"
