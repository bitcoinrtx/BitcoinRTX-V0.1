...
bech32_templates = [
  ...
  ('"brtx',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('"brtx',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('"brtx',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbrtx',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbrtx',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbrtx',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbrtx',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbrtx',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbrtx', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbrtx',   17, 32, False, False, False),
  ('rbrtx',  3,  1, False, False, False),
  ('brtx',   15, 41, False, False, False),
  ('tbrtx',    0, 16, False, False, False),
  ('rbrtx',  0, 32, True,  False, False),
  ('brtx',    0, 16, True,  False, False),
  ('tbrtx',    0, 32, False, True,  False),
  ('rbrtx',  0, 20, False, False, True)
]
